    ...
    implements ICardPileBaseDesignUIRegistry
{
    ...
    private static Collection<ICardPileBaseDesignUI> getForeignCardPileBaseDesignUIs()
    {
        ...
        for( final IConfigurationElement configurationElement : extensionRegistry.getConfigurationElementsFor( Activator.SYMBOLIC_NAME, Activator.EXTENSION_CARD_PILE_BASE_DESIGN_UIS ) )
        {
            try
            {
