 ...
 *
 * Created on Apr 14, 2008 at 10:07:01 PM.
 */
...
/**
 * A command that returns the engine command history.
 * 
 * <p>
 ...
 */
@Immutable
public final class GetCommandHistoryCommand
    extends AbstractCommand<List<IInvertibleCommand<?>>>
{
    // ======================================================================
    // Constructors
    // ======================================================================
    ...
    /**
     * Initializes a new instance of the {@code GetCommandHistoryCommand} class.
     */
    public GetCommandHistoryCommand()
    {
        super();
    }
     ...
     */
    public List<IInvertibleCommand<?>> execute(
        ...
        throws EngineException
    {
        ...
        return history.getCommands( context );
    }
}
