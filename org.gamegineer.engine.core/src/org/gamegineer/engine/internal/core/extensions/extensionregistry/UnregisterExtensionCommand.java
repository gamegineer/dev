/*
 * UnregisterExtensionCommand.java
 ...
 *
 * Created on Apr 17, 2008 at 10:21:10 PM.
 */
...
/**
 * A command that unregisters an engine extension.
 * 
 * <p>
...
@Immutable
public final class UnregisterExtensionCommand
    extends AbstractInvertibleCommand<Void>
{
    ...
    /**
     * Initializes a new instance of the {@code UnregisterExtensionCommand}
     * class.
     * 
     * @param extension
     *        The extension to unregister; must not be {@code null}.
     * 
     * @throws java.lang.NullPointerException
     *         If {@code extension} is {@code null}.
     */
    public UnregisterExtensionCommand(
        /* @NonNull */
