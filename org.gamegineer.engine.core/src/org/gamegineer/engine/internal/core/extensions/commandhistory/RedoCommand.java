 ...
 *
 * Created on Apr 26, 2008 at 10:23:33 PM.
 */
...
/**
 * A command that executes the most recent command in the undo history and adds
 * it to the command history.
 * 
 * <p>
    ...
    extends AbstractInvertibleCommand<Void>
{
    ...
    /**
     * Initializes a new instance of the {@code RedoCommand} class.
     */
    public RedoCommand()
    {
        super();
