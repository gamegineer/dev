...
import org.gamegineer.common.persistence.schemes.beans.FakeNonPersistableClass;
import org.gamegineer.common.persistence.schemes.beans.FakeNonPersistableClassPersistenceDelegate;
import org.gamegineer.common.persistence.schemes.beans.services.persistencedelegateregistry.IPersistenceDelegateRegistry;
import org.gamegineer.common.persistence.schemes.beans.services.persistencedelegateregistry.PersistenceDelegateRegistryConstants;
 ...
 * {@link org.gamegineer.common.internal.persistence.schemes.beans.services.persistencedelegateregistry.PersistenceDelegateProxy}
    ...
    extends AbstractPersistenceDelegateTestCase
{
    ...
    /*
     * @see org.gamegineer.common.persistence.schemes.beans.AbstractPersistenceDelegateTestCase#registerPersistenceDelegates(org.gamegineer.common.persistence.schemes.beans.services.persistencedelegateregistry.IPersistenceDelegateRegistry)
     */
    @Override
    ...
    /*
     * @see org.gamegineer.common.persistence.schemes.beans.AbstractPersistenceDelegateTestCase#setUp()
     */
    @Before
    @Override
    public void setUp()
    ...
    /*
     * @see org.gamegineer.common.persistence.schemes.beans.AbstractPersistenceDelegateTestCase#tearDown()
     */
    @After
    @Override
