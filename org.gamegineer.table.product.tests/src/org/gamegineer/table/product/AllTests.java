 ...
 *
 * Created on Sep 16, 2009 at 11:17:38 PM.
 */

package org.gamegineer.table.product;

import junit.framework.Test;
import org.gamegineer.table.internal.product.Activator;
...
public final class AllTests
{
    ...
    {
        return BundleSuiteBuilder.suite( Activator.getDefault().getBundleContext().getBundle(), "org.gamegineer.table.product.tests" ); //$NON-NLS-1$
    }
}
