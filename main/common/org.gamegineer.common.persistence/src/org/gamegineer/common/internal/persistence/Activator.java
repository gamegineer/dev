    ...
    implements BundleActivator
{
     ...
     */
    public org.gamegineer.common.persistence.serializable.@Nullable IPersistenceDelegateRegistry getSerializablePersistenceDelegateRegistry()
    {
        synchronized( lock_ )
        {
            return ServiceTrackerUtils.openService( serializablePersistenceDelegateRegistryTrackerRef_, getBundleContextInternal(), org.gamegineer.common.persistence.serializable.IPersistenceDelegateRegistry.class );
        }
    }
