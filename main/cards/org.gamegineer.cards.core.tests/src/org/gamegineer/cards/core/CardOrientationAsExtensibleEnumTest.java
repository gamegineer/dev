...
/**
 * A fixture for testing the {@link CardOrientation} class to ensure it does not
 * violate the contract of the {@link ExtensibleEnum} class
 */
    ...
    extends AbstractExtensibleEnumTestCase
{
    ...
    {
        return nonNull( CardOrientation.class );
    }
}
