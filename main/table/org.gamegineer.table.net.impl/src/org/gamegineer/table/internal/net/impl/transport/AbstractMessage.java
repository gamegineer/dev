    ...
    implements IMessage
{
    ...
    /*
     * @see org.gamegineer.table.internal.net.impl.transport.IMessage#getCorrelationId()
     */
    @Override
    ...
    /*
     * @see org.gamegineer.table.internal.net.impl.transport.IMessage#getId()
     */
    @Override
    ...
    /*
     * @see org.gamegineer.table.internal.net.impl.transport.IMessage#setCorrelationId(int)
     */
    @Override
    ...
    /*
     * @see org.gamegineer.table.internal.net.impl.transport.IMessage#setId(int)
     */
    @Override
