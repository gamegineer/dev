...
/**
 * A fixture for testing the {@link MainModelListener} class to ensure it does
 * not violate the contract of the {@link IMainModelListener} interface.
 */
    ...
    extends AbstractMainModelListenerTestCase
{
    ...
    /*
     * @see org.gamegineer.table.internal.ui.impl.model.AbstractMainModelListenerTestCase#createMainModelListener()
     */
    @Override
