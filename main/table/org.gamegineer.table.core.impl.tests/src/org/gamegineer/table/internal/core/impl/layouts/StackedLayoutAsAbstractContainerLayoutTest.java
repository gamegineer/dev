/*
 * StackedLayoutAsAbstractContainerLayoutTest.java
 ...
 *
 * Created on Nov 30, 2012 at 9:37:02 PM.
 */
 ...
 */
public final class StackedLayoutAsAbstractContainerLayoutTest
    extends AbstractAbstractContainerLayoutTestCase<StackedLayout>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code StackedLayoutAsAbstractContainerLayoutTest} class.
     */
    public StackedLayoutAsAbstractContainerLayoutTest()
    {
    }
     ...
     */
    @Override
    protected StackedLayout createContainerLayout()
    {
