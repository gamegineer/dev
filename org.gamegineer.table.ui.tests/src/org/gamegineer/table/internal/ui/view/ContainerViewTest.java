...
public final class ContainerViewTest
{
    ...
    public void setUp()
        throws Exception
    {
        containerView_ = new ContainerView( ComponentModelFactory.createContainerModel( Components.createUniqueContainer( TableEnvironmentFactory.createTableEnvironment() ) ) );
    }
