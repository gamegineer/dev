...
public final class ComponentViewTest
{
    ...
    public void setUp()
        throws Exception
    {
        componentView_ = new ComponentView( ComponentModelFactory.createComponentModel( TestComponents.createUniqueComponent( TableEnvironmentFactory.createTableEnvironment() ) ) );
    }

    /**
     * Ensures the {@link ComponentView#getBounds} method returns a copy of the
     * bounds.
     */
    @Test
    ...
    /**
     * Ensures the {@link ComponentView#getBounds} method does not return
     * {@code null}.
     */
    @Test
