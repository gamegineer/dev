...
public final class SwingTextUtilitiesTest
{
    ...
    public void testShortenPath_Components_2()
    {
        ...
        assertEquals( normalizePath( "C:\\filename.ext" ), SwingTextUtilities.shortenPath( path, 8 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\filename.ext" ), SwingTextUtilities.shortenPath( path, 14 ) ); //$NON-NLS-1$
    }
    ...
    public void testShortenPath_Components_3()
    {
        ...
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 8 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 14 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 19 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\filename.ext" ), SwingTextUtilities.shortenPath( path, 20 ) ); //$NON-NLS-1$
    }
    ...
    public void testShortenPath_Components_4()
    {
        ...
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 14 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 19 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 24 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\filename.ext" ), SwingTextUtilities.shortenPath( path, 25 ) ); //$NON-NLS-1$
    }
    ...
    public void testShortenPath_Components_5()
    {
        ...
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 19 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 24 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\dir3\\filename.ext" ), SwingTextUtilities.shortenPath( path, 29 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\dir3\\filename.ext" ), SwingTextUtilities.shortenPath( path, 30 ) ); //$NON-NLS-1$
    }
    ...
    public void testShortenPath_Components_6()
    {
        ...
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 19 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 24 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\dir4\\filename.ext" ), SwingTextUtilities.shortenPath( path, 29 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\...\\dir4\\filename.ext" ), SwingTextUtilities.shortenPath( path, 34 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\dir3\\dir4\\filename.ext" ), SwingTextUtilities.shortenPath( path, 35 ) ); //$NON-NLS-1$
    }
    ...
    public void testShortenPath_Components_7()
    {
        ...
        assertEquals( normalizePath( "C:\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 19 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\filename.ext" ), SwingTextUtilities.shortenPath( path, 24 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\...\\dir5\\filename.ext" ), SwingTextUtilities.shortenPath( path, 29 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\...\\dir5\\filename.ext" ), SwingTextUtilities.shortenPath( path, 34 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\...\\dir4\\dir5\\filename.ext" ), SwingTextUtilities.shortenPath( path, 39 ) ); //$NON-NLS-1$
        assertEquals( normalizePath( "C:\\dir1\\dir2\\dir3\\dir4\\dir5\\filename.ext" ), SwingTextUtilities.shortenPath( path, 40 ) ); //$NON-NLS-1$
    }
    ...
    {
        SwingTextUtilities.shortenPath( "path", -1 ); //$NON-NLS-1$
    }
