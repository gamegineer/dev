...
public final class CardSurfaceDesignUIFactoryTest
{
    ...
    {
        CardSurfaceDesignUIFactory.createCardSurfaceDesignUI( null, "name", createDummy( Icon.class ) ); //$NON-NLS-1$
    }
    ...
    {
        CardSurfaceDesignUIFactory.createCardSurfaceDesignUI( CardSurfaceDesignId.fromString( "id" ), null, createDummy( Icon.class ) ); //$NON-NLS-1$
    }
}
