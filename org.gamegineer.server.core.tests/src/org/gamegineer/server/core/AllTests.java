 ...
 *
 * Created on Sep 13, 2008 at 10:12:56 PM.
 */

package org.gamegineer.server.core;

import junit.framework.Test;
import org.gamegineer.server.internal.core.Activator;
...
public final class AllTests
{
    ...
    {
        return BundleSuiteBuilder.suite( Activator.getDefault().getBundleContext().getBundle(), "org.gamegineer.server.core.tests" ); //$NON-NLS-1$
    }
}
