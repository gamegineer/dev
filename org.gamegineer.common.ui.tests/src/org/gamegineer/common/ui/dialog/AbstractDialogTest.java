...
public final class AbstractDialogTest
{
    ...
    /**
     * Ensures the {@code initializeDialogUnits} method throws an exception when
     * passed a {@code null} component.
     */
    @Test( expected = NullPointerException.class )
    public void testInitializeDialogUnits_Component_Null()
    {
        dialog_.initializeDialogUnits( null );
    }
