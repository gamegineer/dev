 ...
 *
 * Created on Aug 8, 2008 at 10:59:30 PM.
 */
...
/**
 * A command that deactivates the current stage.
 * 
 * <p>
 * A stage submits this command to trigger the deactivation of the current stage
 * (i.e. itself). If this command is received when the originating stage is no
 * longer the currently executing stage or is not at the same change level when
 * it submitted the command, it will be silently ignored.
 * </p>
 * 
 * <p>
...
@Immutable
public final class DeactivateStageCommand
    extends AbstractStageCommand
{
    ...
    /**
     * Initializes a new instance of the {@code DeactivateStageCommand} class.
     * 
     * @param sourceStageId
        ...
        throws EngineException
    {
        ...
        GameAttributes.ROOT_STAGE.getValue( context.getState() ).deactivate( context );
    }
}
