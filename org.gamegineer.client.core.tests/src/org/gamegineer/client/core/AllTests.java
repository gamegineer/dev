 ...
 *
 * Created on Sep 15, 2008 at 9:48:53 PM.
 */
...
public final class AllTests
{
    ...
    {
        return BundleSuiteBuilder.suite( Activator.getDefault().getBundleContext().getBundle(), "org.gamegineer.client.core.tests" ); //$NON-NLS-1$
    }
}
