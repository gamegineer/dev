/*
 * GetGameSystemIdCommandAsCommandTest.java
 ...
 *
 * Created on Feb 10, 2009 at 10:43:36 PM.
 */
 ...
 */
public final class GetGameSystemIdCommandAsCommandTest
    extends AbstractCommandTestCase<GetGameSystemIdCommand, String>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code GetGameSystemIdCommandAsCommandTest} class.
     */
    public GetGameSystemIdCommandAsCommandTest()
    {
        super();
    }
     ...
     */
    @Override
    protected GetGameSystemIdCommand createCommand()
    {
