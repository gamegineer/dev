/*
 * IsGameCompleteCommandAsCommandTest.java
 ...
 *
 * Created on Sep 2, 2008 at 11:38:22 PM.
 */
 ...
 */
public final class IsGameCompleteCommandAsCommandTest
    extends AbstractCommandTestCase<IsGameCompleteCommand, Boolean>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code IsGameCompleteCommandAsCommandTest} class.
     */
    public IsGameCompleteCommandAsCommandTest()
    {
        super();
    }
     ...
     */
    @Override
    protected IsGameCompleteCommand createCommand()
    {
