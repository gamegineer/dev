    ...
    implements ICardPileBaseDesign
{
        ...
        final int height )
    {
        ...
        assertArgumentLegal( width >= 0, "width", NonNlsMessages.CardPileBaseDesign_ctor_width_negative ); //$NON-NLS-1$
        assertArgumentLegal( height >= 0, "height", NonNlsMessages.CardPileBaseDesign_ctor_height_negative ); //$NON-NLS-1$
