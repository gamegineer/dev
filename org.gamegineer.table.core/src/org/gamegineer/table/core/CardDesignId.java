 ...
 * 
 * <p>
 * An instance of {@code CardDesignId} is suitable for use as a key in a hash
 * container.
 * </p>
 */
@Immutable
public final class CardDesignId
{
    // ======================================================================
    // Fields
    // ======================================================================
    ...
    /**
     * Initializes a new instance of the {@code CardDesignId} class.
     * 
     * @param id
     *        The underlying identifier; must not be {@code null}.
     */
    private CardDesignId(
        /* @NonNull */
        final String id )
    {
        assert id != null;
        ...
        final Object obj )
    {
        ...
        if( !(obj instanceof CardDesignId) )
        {
            return false;
        }

        final CardDesignId other = (CardDesignId)obj;
        return id_.equals( other.id_ );
    }

    /**
     * Creates a new instance of the {@code CardDesignId} class from the
     ...
     *        null}.
     * 
     * @return A new instance of the {@code CardDesignId} class; never {@code
     *         null}.
     * 
     ...
     */
    /* @NonNull */
    public static CardDesignId fromString(
        /* @NonNull */
        final String id )
    {
        assertArgumentNotNull( id, "id" ); //$NON-NLS-1$

        return new CardDesignId( id );
    }
