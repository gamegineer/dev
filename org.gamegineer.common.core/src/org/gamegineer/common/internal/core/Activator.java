    ...
    implements BundleActivator
{
    ...
    public final static String EXTENSION_COMPONENT_FACTORIES = "componentFactories"; //$NON-NLS-1$

    /** The symbolic name of the bundle. */
    public final static String SYMBOLIC_NAME = "org.gamegineer.common.core"; //$NON-NLS-1$
