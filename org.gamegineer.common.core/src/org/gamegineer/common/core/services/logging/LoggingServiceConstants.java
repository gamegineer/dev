...
public final class LoggingServiceConstants
{
    ...
    public static final String PROPERTY_COMPONENT_FACTORY_INSTANCE_NAME = "org.gamegineer.common.core.services.logging.instanceName"; //$NON-NLS-1$

    /** The name of the component factory logging properties property. */
    public static final String PROPERTY_COMPONENT_FACTORY_LOGGING_PROPERTIES = "org.gamegineer.common.core.services.logging.loggingProperties"; //$NON-NLS-1$

    /** The name of the component factory type name property. */
    public static final String PROPERTY_COMPONENT_FACTORY_TYPE_NAME = "org.gamegineer.common.core.services.logging.typeName"; //$NON-NLS-1$
