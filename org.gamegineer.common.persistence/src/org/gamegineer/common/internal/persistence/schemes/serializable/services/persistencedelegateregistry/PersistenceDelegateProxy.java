    ...
    implements IPersistenceDelegate
{
    ...
    /*
     * @see org.gamegineer.common.persistence.schemes.serializable.IPersistenceDelegate#annotateClass(org.gamegineer.common.persistence.schemes.serializable.ObjectOutputStream, java.lang.Class)
     */
    @Override
    ...
    private IPersistenceDelegate getActualPersistenceDelegate()
    {
        synchronized( lock_ )
        {
            assertStateLegal( !isDisposed_, Messages.PersistenceDelegateProxy_getPersistenceDelegate_proxyDisposed );
            ...
            assertStateLegal( persistenceDelegate_ != null, Messages.PersistenceDelegateProxy_getPersistenceDelegate_actualObjectNotAvailable );
    ...
    /*
     * @see org.gamegineer.common.persistence.schemes.serializable.IPersistenceDelegate#resolveClass(org.gamegineer.common.persistence.schemes.serializable.ObjectInputStream, java.io.ObjectStreamClass)
     */
    @Override
