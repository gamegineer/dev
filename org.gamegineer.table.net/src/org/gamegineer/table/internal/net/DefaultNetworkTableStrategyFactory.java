 ...
 *
 * Created on Dec 27, 2010 at 8:12:20 PM.
 */
...
/**
 * The default network table strategy factory.
 * 
 * <p>
 * The strategies produced by this factory use TCP to communicate over the
 * network.
 * </p>
 */
@Immutable
final class DefaultNetworkTableStrategyFactory
    extends AbstractNetworkTableStrategyFactory
{
     ...
     */
    DefaultNetworkTableStrategyFactory()
    {
        super();
    }
        ...
        final NetworkTable networkTable )
    {
        ...
        return new DefaultClientNetworkTableStrategy( networkTable );
    }
        ...
        final NetworkTable networkTable )
    {
        ...
        return new DefaultServerNetworkTableStrategy( networkTable );
    }
}
