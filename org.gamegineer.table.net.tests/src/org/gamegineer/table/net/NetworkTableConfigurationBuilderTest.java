/*
 * NetworkTableConfigurationBuilderTest.java
 ...
 * {@link org.gamegineer.table.net.NetworkTableConfigurationBuilder} class.
 */
public final class NetworkTableConfigurationBuilderTest
{
    // ======================================================================
    // Fields
    // ======================================================================

    /** The network table configuration builder under test in the fixture. */
    private NetworkTableConfigurationBuilder builder_;
     ...
     * NetworkTableConfigurationBuilderTest} class.
     */
    public NetworkTableConfigurationBuilderTest()
    {
        super();
    }
    ...
    public void setUp()
        throws Exception
    {
        builder_ = new NetworkTableConfigurationBuilder();
    }
