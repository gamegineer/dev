 ...
 *
 * Created on Mar 21, 2008 at 11:13:06 PM.
 */

package org.gamegineer.engine.core;

import junit.framework.Test;
import org.gamegineer.engine.internal.core.Activator;
...
public final class AllTests
{
    ...
    {
        return BundleSuiteBuilder.suite( Activator.getDefault().getBundleContext().getBundle(), "org.gamegineer.engine.core.tests" ); //$NON-NLS-1$
    }
}
