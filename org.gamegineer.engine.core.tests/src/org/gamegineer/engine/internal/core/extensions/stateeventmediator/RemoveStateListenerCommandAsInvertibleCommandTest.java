/*
 * RemoveStateListenerCommandAsInvertibleCommandTest.java
 ...
 *
 * Created on Jun 10, 2008 at 11:52:04 PM.
 */
 ...
 */
public final class RemoveStateListenerCommandAsInvertibleCommandTest
    extends AbstractInvertibleCommandTestCase<RemoveStateListenerCommand, Void>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code RemoveStateListenerCommandAsInvertibleCommandTest} class.
     */
    public RemoveStateListenerCommandAsInvertibleCommandTest()
    {
        super();
    }
    ...
    {
        return new RemoveStateListenerCommand( new MockStateListener() );
    }
