/*
 * InternalCommandExecutingEventAsCommandExecutingEventTest.java
 ...
 *
 * Created on Jun 2, 2008 at 11:15:06 PM.
 */
 ...
 * interface.
 */
public final class InternalCommandExecutingEventAsCommandExecutingEventTest
    extends AbstractCommandExecutingEventTestCase<InternalCommandExecutingEvent>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code InternalCommandExecutingEventAsCommandExecutingEventTest} class.
     */
    public InternalCommandExecutingEventAsCommandExecutingEventTest()
    {
        super();
    }
     ...
     */
    @Override
    protected InternalCommandExecutingEvent createCommandEvent()
    {
