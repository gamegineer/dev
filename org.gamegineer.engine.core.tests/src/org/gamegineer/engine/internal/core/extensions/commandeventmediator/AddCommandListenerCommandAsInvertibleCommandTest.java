/*
 * AddCommandListenerCommandAsInvertibleCommandTest.java
 ...
 *
 * Created on Jun 9, 2008 at 10:48:27 PM.
 */
 ...
 */
public final class AddCommandListenerCommandAsInvertibleCommandTest
    extends AbstractInvertibleCommandTestCase<AddCommandListenerCommand, Void>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code AddCommandListenerCommandAsInvertibleCommandTest} class.
     */
    public AddCommandListenerCommandAsInvertibleCommandTest()
    {
        super();
    }
    ...
    {
        return new AddCommandListenerCommand( new MockCommandListener() );
    }
}
