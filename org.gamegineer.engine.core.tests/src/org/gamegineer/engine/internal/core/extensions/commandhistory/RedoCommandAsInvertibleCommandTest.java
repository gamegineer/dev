/*
 * RedoCommandAsInvertibleCommandTest.java
 ...
 *
 * Created on Apr 26, 2008 at 11:35:55 PM.
 */
 ...
 */
public final class RedoCommandAsInvertibleCommandTest
    extends AbstractInvertibleCommandTestCase<RedoCommand, Void>
{
    // ======================================================================
    // Constructors
    // ======================================================================
     ...
     * {@code RedoCommandAsInvertibleCommandTest} class.
     */
    public RedoCommandAsInvertibleCommandTest()
    {
        super();
    }
        ...
        throws Exception
    {
        ...
        engine.executeCommand( MockCommands.createAddAttributeCommand( new AttributeName( Scope.APPLICATION, "RedoCommandAsInvertibleCommandTest.attribute" ), "value" ) ); //$NON-NLS-1$ //$NON-NLS-2$
