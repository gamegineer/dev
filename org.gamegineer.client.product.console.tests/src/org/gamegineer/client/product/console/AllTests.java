 ...
 *
 * Created on Sep 19, 2008 at 11:00:39 PM.
 */

package org.gamegineer.client.product.console;

import junit.framework.Test;
import org.gamegineer.client.internal.product.console.Activator;
...
public final class AllTests
{
    ...
    {
        return BundleSuiteBuilder.suite( Activator.getDefault().getBundleContext().getBundle(), "org.gamegineer.client.product.console.tests" ); //$NON-NLS-1$
    }
}
