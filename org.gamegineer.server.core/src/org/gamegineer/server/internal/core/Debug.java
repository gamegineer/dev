 ...
 *
 * Created on Sep 13, 2008 at 9:58:54 PM.
 */
    ...
    extends org.gamegineer.common.core.runtime.Debug
{
    ...
    /** The name of the configuration package debug option key. */
    private static final String OPTION_DEBUG_CONFIGURATION = OPTION_DEBUG + "/config"; //$NON-NLS-1$

    /** Indicates the debug option for the configuration package is enabled. */
    public static final boolean CONFIGURATION;
    ...
    static
    {
        ...
        CONFIGURATION = DEFAULT && debugOptions.getBooleanOption( OPTION_DEBUG_CONFIGURATION, false );
    }
